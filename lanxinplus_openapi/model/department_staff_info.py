...
class DepartmentStaffInfo(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DepartmentStaffInfo - a model defined in OpenAPI
