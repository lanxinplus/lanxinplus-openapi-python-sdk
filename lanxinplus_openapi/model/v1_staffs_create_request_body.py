...
class V1StaffsCreateRequestBody(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'extraFieldSet': ({str: (str,)},),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """V1StaffsCreateRequestBody - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            avatarUrl (str): 头像地址. [optional]  # noqa: E501
            birthdate (str): 生日. [optional]  # noqa: E501
            career ([Resume]): 职业. [optional]  # noqa: E501
            departments ([UDepartment]): 部门. [optional]  # noqa: E501
            disablePasswordReset (bool): 账密登录方式，首次登录时是否禁用强制修改密码。 禁用 - true 不禁用 - false (默认). [optional]  # noqa: E501
            duties (str): 职务. [optional]  # noqa: E501
            education ([Resume]): 教育程度. [optional]  # noqa: E501
            email (str): 电子邮箱地址, loginWays指定邮箱登录时不能为空. [optional]  # noqa: E501
            employeeNumber (str): 人员号. [optional]  # noqa: E501
            extAttr1 (str): 扩展字段. [optional]  # noqa: E501
            extAttr2 (str): 扩展字段. [optional]  # noqa: E501
            externalId (str): 人员外部ID，组织通讯录数据源唯一标识人员的ID。注意，如果是账号密码方式登录蓝信，应该使用loginName字段。如果是手机号方式登录蓝信，又想保留组织内的人员唯一ID，可以使用该externalId 字段。externalId 和 employeeNumber类似，用于组织内人员的唯一标识。创建后不可修改，组织内必须唯一。. [optional]  # noqa: E501
            extraFieldSet ({str: (str,)}): 自定义扩展属性，k代表扩展字段ID，这个ID由蓝信管理后台预定义，应用可以通过以下接口获取获取组织预定义的人员扩展字段ID列表。. [optional]  # noqa: E501
            ...
            loginName (str): 账密登录方式的登录账号，loginWays指定账密方式登录时不能为空。创建后不可修改，组织内必须唯一。. [optional]  # noqa: E501
            loginPassword (str): 登录方式为账密登录时，设置账户的登录密码，不能为空，为避免密码泄漏，要求原始密码使用哈希算法计算哈希值后再填充该字段，具体哈希算法需要联系组织管理员确认(算法为组织配置，例如SHA256)。. [optional]  # noqa: E501
            loginWays ([int]): 蓝信登录方式：0-手机号， 1-邮箱， 2-账密。不填时默认手机号且手机号不能为空。目前一个人只支持一种登录方式。特别说明：如果指定账密登录方式时，需要通过蓝信超级管理员在对应的组织上创建一个组织标识. [optional]  # noqa: E501
            mobilePhone (MobilePhone): [optional]  # noqa: E501
            name (str): 人员姓名. [optional]  # noqa: E501
            nationality (str): 国家. [optional]  # noqa: E501
            nativePlace (str): 籍贯. [optional]  # noqa: E501
            orgId (str): 人员所在组织Id. [optional]  # noqa: E501
            parties (str): 党派. [optional]  # noqa: E501
            signature (str): 人员个人签名. [optional]  # noqa: E501
            smsInvitation (bool): 是否发送验证码. [optional]  # noqa: E501
            status (int): 状态. [optional]  # noqa: E501
