...
class V1TagsMetaFetchRequestBody(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """V1TagsMetaFetchRequestBody - a model defined in OpenAPI
